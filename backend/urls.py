...
urlpatterns = [
    ...
    path('problems/', TemplateView.as_view(template_name='problems/list.html'), name='problem_list'),
    path('problems/<int:pk>/', TemplateView.as_view(template_name='problems/detail.html'), name='problem_detail'),
